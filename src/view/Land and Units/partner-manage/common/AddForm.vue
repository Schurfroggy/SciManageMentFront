...
const handleAddSubmit = () => {
  ...
  $api.post('/partner/add?id=' + newdata.partnerID + '&name=' + newdata.name + '&address=' + newdata.address + '&head_id=' + newdata.headID + '&links=' + newdata.linkID).then(() => {
    ElMessageBox({
      message: '新增成功',
      type: 'success',
      showClose: true
...
const handleEditSubmit = (data) => {
  const newdata = state.formData
  $api.put('/partner/update?id=' + newdata.partnerID + '&name=' + newdata.name + '&address=' + newdata.address + '&head_id=' + newdata.headID + '&links=' + newdata.linkID).then(() => {
    ElMessageBox({
      message: '修改成功',
      type: 'success',
      showClose: true
