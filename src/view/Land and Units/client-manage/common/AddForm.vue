...
const handleAddSubmit = () => {
  ...
  $api.post('/client/add?id=' + newdata.clientID + '&name=' + newdata.name + '&address=' + newdata.address + '&head_id=' + newdata.headID + '&links=' + newdata.linkID).then(() => {
    ElMessageBox({
      message: '新增成功',
      type: 'success',
      showClose: true
...
const handleEditSubmit = (data) => {
  const newdata = state.formData
  $api.put('/client/update?id=' + newdata.clientID + '&name=' + newdata.name + '&address=' + newdata.address + '&head_id=' + newdata.headID + '&links=' + newdata.linkID).then(() => {
    ElMessageBox({
      message: '修改成功',
      type: 'success',
      showClose: true
